...
- **Obsidian-style Enter markdown behavior** -- pressing Enter after markdown prefixes auto-continues or finalizes lists, tasks, blockquotes, and headings in the notes editor.
